...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "UNICEF for the children in the Democratic Republic of the Congo",
                "currency": "GBP", 
                "type": "email", 
                 "details": { 
                    "email": "donations@unicef.org.uk"
                 } 
               };
