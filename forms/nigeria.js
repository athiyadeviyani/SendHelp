...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "World Health Organization Nigeria",
                "currency": "NGN", 
                "type": "email", 
                 "details": { 
                    "email": "afwcongwho@who.int"
                 } 
               };
  ...
  document.getElementById("msg").innerHTML = "You have donated " + amt + " " + curr + " to World Health Organization Nigeria in NGN (local currency). Please wait until the confirmation alert is displayed before closing the window." ;
