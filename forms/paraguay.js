...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "Paraguayan Red Cross",
                "currency": "GBP", 
                "type": "email", 
                 "details": { 
                    "email": "celeste.lara@cruzroja.org.py"
                 } 
               };
  ...
  document.getElementById("msg").innerHTML = "You have donated " + amt + " " + curr + " to the Paraguayan Red Cross in GBP***.  Please wait until the confirmation alert is displayed before closing the window." + "<br>" + "***We try our best to send money to local charities in their local currency, but in the case where the local currency is not supported by Transferwise, we will send the amount in another acceptable currency.";
