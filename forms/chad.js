...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "Chad Relief Foundation",
                "currency": "USD", 
                "type": "email", 
                 "details": { 
                    "email": "contactus@chadrelief.org"
                 } 
               };
