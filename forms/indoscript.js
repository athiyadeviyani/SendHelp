...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "UNICEF Indonesia",
                "currency": "IDR", 
                "type": "email", 
                 "details": { 
  ...
  document.getElementById("msg").innerHTML = "You have donated " + amt + " " + curr + " to UNICEF Indonesia in IDR (local currency). Please wait until the confirmation alert is displayed before closing the window." ;
