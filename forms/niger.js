...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "Aid for Africa",
                "currency": "USD", 
                "type": "email", 
                 "details": { 
