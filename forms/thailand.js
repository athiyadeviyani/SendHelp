...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "Thai Red Cross",
                "currency": "THB", 
                "type": "email", 
                 "details": { 
                    "email": "intertrc@redcross.or.th"
                 } 
               };
  ...
  document.getElementById("msg").innerHTML = "You have donated " + amt + " " + curr + " to Thai Red Cross in THB (local currency). Please wait until the confirmation alert is displayed before closing the window." ;
