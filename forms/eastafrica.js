...
function submit() {
  ...
  function createQuote() {
    ...
    .then(r => {console.log(r); 
               ...
               var repdata = { 
                "profile": sender_id, 
                "accountHolderName": "Unicef for East Africa",
                "currency": "GBP", 
                "type": "email", 
                 "details": { 
